...
from matchmaker.matching_games import BaseGame, Player, SingleMatching
from matchmaker.matching_games.algorithms import stable_roommates
from matchmaker.matching_games.exceptions import MatchingError
...
class StableRoommates(BaseGame):
    ...
    def check_stability(self, bypass=True):
        ...
        for player in self.players:
            ...
            for other in others:
                if (other, player) not in blocking_pairs:
                    ...
                    prefer_each_other = player.prefers(other, player.matching) and other.prefers(player, other.matching)
    ...
    def check_inputs(self, bypass=True):
